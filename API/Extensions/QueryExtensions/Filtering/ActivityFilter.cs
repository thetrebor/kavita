...
public static class ActivityFilter
{
    ...
    public static IQueryable<AppUserReadingSessionActivityData> ApplyStatsFilter(this IQueryable<AppUserReadingSessionActivityData> queryable, StatsFilterDto filter, int userId)
    {
